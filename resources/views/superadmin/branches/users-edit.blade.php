...
<div class="bg-card-light dark:bg-card-dark rounded-xl shadow-sm border border-border-light dark:border-border-dark p-6">
    <form method="POST" action="{{ route('company.branches.users.update', [$company, $branch, $user]) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <p class="text-sm font-medium text-blue-900 dark:text-blue-100">{{ $branch->name }}</p>
                        <p class="text-xs text-blue-700 dark:text-blue-300">Company: {{ $company->name }}</p>
                    </div>
                </div>
            </div>
        </div>
