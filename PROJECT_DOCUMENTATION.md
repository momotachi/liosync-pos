...
*   **Payment Flow:** 
    *   Manual Bank Transfer method with configurable bank details (Superadmin).
    *   Payment proof upload (max 5MB, image only).
    *   Superadmin verification and approval process.
    *   Subscription activation starts from approval date (not request date).
...
# Appendix: Credentials & User Data

```text
=============================================================================
                    JUICEPOS - CURRENT USER CREDENTIALS
                           (Database Dump)
=============================================================================
...
=============================================================================
                        COMPANY ADMINS
=============================================================================
1. Name: admin_eshjuice
   Email: companyadmin@eshjuice.com
   Role: Company Admin
   Password: password (Assumed - Not Verified)

2. Name: dheny susanto
   Email: masdengrup@gmail.com
   Role: Company Admin
   Password: password (Assumed - Not Verified)
