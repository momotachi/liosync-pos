...
<div class="mb-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage branches for this company</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        @if($branch->address)
                                            <div class="text-xs text-gray-500 dark:text-gray-400">{{ Str::limit($branch->address, 40) }}</div>
                                        @endif
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <!-- Users Button -->
                                    <a href="{{ route('company.users.index', $company) }}?branch_id={{ $branch->id }}"
                                    ...
                                    <!-- Enter Button -->
                                    <a href="/superadmin/switch-branch/{{ $branch->id }}"
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('company.branches.destroy', [$company, $branch]) }}"
                                          method="POST"
                                          class="inline"
    ...
    @else
        ...
        <div class="text-center py-16">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-800 mb-4">
                <span class="material-symbols-outlined text-3xl text-gray-400 dark:text-gray-600">store</span>
            </div>
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No branches yet</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Get started by creating your first branch</p>
            <a href="{{ route('company.branches.create', $company) }}"
               class="inline-flex items-center px-4 py-2 bg-primary hover:bg-primary-dark text-white rounded-lg text-sm font-medium transition-colors">
                <span class="material-symbols-outlined text-sm mr-1">add</span>
                Create Branch
